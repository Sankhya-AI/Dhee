...
import type { WorkspaceGraphEdge, WorkspaceGraphNode } from "../../../types";

function assert(cond: unknown, msg: string) {
  if (!cond) throw new Error(`assertion failed: ${msg}`);
}

function demoGraph(): { nodes: WorkspaceGraphNode[]; links: WorkspaceGraphEdge[] } {
  ...
  const links: WorkspaceGraphEdge[] = [
