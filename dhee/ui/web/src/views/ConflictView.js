...
export function ConflictView({ viewer, onChanged }) {
    ...
    return (_jsxs("div", { className: "inbox-shell", style: { display: "flex", height: "100%", minHeight: 0 }, children: [_jsxs("aside", { className: "inbox-sidebar", style: {
                    width: 300,
                    ...
                    flexShrink: 0,
                            ...
                            fontSize: 10,
                            lineHeight: 1.5,
                        }, children: error })) : null] }), _jsxs("main", { className: "inbox-main", style: {
                    flex: 1,
                    minWidth: 0,
                    overflowY: "auto",
                    background: "var(--bg)",
