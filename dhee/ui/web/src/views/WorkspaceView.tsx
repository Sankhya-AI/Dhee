...
export function WorkspaceView({
  ...
  if (!currentProject || !currentWorkspace || !currentSession) {
    return (
      ...
      >
        <FirstRunPanel
          title="No mirrored workspace session yet"
          body="Add a repo folder or start a task from an existing workspace. Once an agent session is mirrored, this view becomes the working console."
          actions={[
