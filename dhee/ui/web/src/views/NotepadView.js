...
export function NotepadView({ projectIndex, memories, tokensSaved, onAddMemory, onSelectSession, onCreateWorkspace, onLaunchSession, onOpenWorkspace, onOpenTasks, }) {
    ...
    return (_jsxs("div", { style: { height: "100%", display: "flex", flexDirection: "column", overflow: "hidden" }, children: [_jsxs("div", { style: {
                    ...
                    zIndex: 40,
                        ...
                        background: "white",
                        padding: 20,
                    }, children: [_jsx("div", { style: { marginBottom: 14, fontFamily: "var(--mono)", fontSize: 10, color: "var(--ink3)" }, children: "ADD WORKSPACE" }), _jsxs("div", { style: { display: "grid", gap: 10 }, children: [_jsx("input", { value: workspaceName, onChange: (e) => setWorkspaceName(e.target.value), placeholder: "Workspace name", style: { border: "1px solid var(--border)", padding: "11px 12px", background: "white" } }), _jsx("div", { style: { fontFamily: "var(--mono)", fontSize: 9, color: "var(--ink3)", lineHeight: 1.5 }, children: "A workspace is a collection of projects. Add projects and their folders after creating it." }), _jsxs("div", { style: { display: "flex", justifyContent: "flex-end", gap: 8, marginTop: 4 }, children: [_jsx("button", { onClick: () => setShowWorkspaceModal(false), style: {
                                                padding: "10px 12px",
                                                border: "1px solid var(--border)",
                                                background: "white",
                                                fontFamily: "var(--mono)",
